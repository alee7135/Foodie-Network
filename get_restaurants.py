...
'''
The purpose of this class is to get all of the restaurant businesses in San Francisco so that I can then use yelp_scraper to loop through and retrieve relevant users(reviewers) and reviews for each restaurant.
'''
...
def main():
    ...
    # yelp_scrape.create_collection('users')
